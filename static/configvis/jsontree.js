...
((e) => {
    ...
    ((e) => {
        ...
        function o(e) {
            return (
                e.toString().toLowerCase().trim() === 'true' ||
                e.toString().toLowerCase().trim() === 'false'
            );
        }
        e.boolean = o;
        function r(e) {
        ...
        try {
            ...
            try {
                ...
                if (!configuration.safeMode) {
                    console.error(
                        configuration.text.objectErrorText
...
((e) => {
    ...
    ((t) => {
        ...
        function o(e) {
            ...
            t.dateTimeFormat = Default2.getString(
                t.dateTimeFormat,
            ...
            t.sortPropertyNamesInAlphabeticalOrder = Default2.getBoolean(
            ...
            t.showArrayItemsAsSeparateObjects = Default2.getBoolean(
                t.showArrayItemsAsSeparateObjects,
                false
            );
            ...
            t.showOpeningClosingCurlyBraces = Default2.getBoolean(
                t.showOpeningClosingCurlyBraces,
                false
            );
            t.showOpeningClosingSquaredBrackets = Default2.getBoolean(
                t.showOpeningClosingSquaredBrackets,
                false
            );
            t.includeTimeZoneInDateTimeEditing = Default2.getBoolean(
                t.includeTimeZoneInDateTimeEditing,
                true
            );
...
((e) => {
    ...
    ((e) => {
        ...
        function n(e) {
            ...
            e.text.closeAllButtonText = Default2.getAnyString(
                e.text.closeAllButtonText,
                'Close All'
            );
            ...
            e.text.objectErrorText = Default2.getAnyString(
                e.text.objectErrorText,
                'Errors in object: {{error_1}}, {{error_2}}'
            );
            e.text.attributeNotValidErrorText = Default2.getAnyString(
                e.text.attributeNotValidErrorText,
                "The attribute '{{attribute_name}}' is not a valid object."
            );
            e.text.attributeNotSetErrorText = Default2.getAnyString(
            ...
            e.text.closeAllButtonSymbolText = Default2.getAnyString(
                e.text.closeAllButtonSymbolText,
                '↑'
            );
            e.text.openAllButtonSymbolText = Default2.getAnyString(
                e.text.openAllButtonSymbolText,
                '↓'
            );
            e.text.copyAllButtonSymbolText = Default2.getAnyString(
                e.text.copyAllButtonSymbolText,
                '❐'
            );
            ...
            e.text.noJsonToViewText = Default2.getAnyString(
                e.text.noJsonToViewText,
                'There is currently no JSON to view.'
            );
...
(() => {
        ...
        if (Is.defined(t) && t.hasAttribute(Constants.JSONTREE_JS_ATTRIBUTE_NAME)) {
            ...
            if (Is.definedString(o)) {
                ...
                if (r.parsed && Is.definedObject(r.object)) {
                    ...
                    if (!e.safeMode) {
                        console.error(
                            e.text.attributeNotValidErrorText.replace(
                                '{{attribute_name}}',
                ...
                if (!e.safeMode) {
                    console.error(
                        e.text.attributeNotSetErrorText.replace(
                            '{{attribute_name}}',
                            Constants.JSONTREE_JS_ATTRIBUTE_NAME
                        )
                    );
        ...
        if (t.title.show || t.title.showTreeControls || t.title.showCopyButton) {
            ...
            if (t.title.show) {
                DomElement.createWithHTML(
                    ...
                    'title',
                    t.title.text,
                    t._currentView.titleBarButtons
                );
            }
            if (t.title.showCopyButton) {
                const o = DomElement.createWithHTML(
                    t._currentView.titleBarButtons,
                    'button',
                    'copy-all',
                    e.text.copyAllButtonSymbolText
            ...
            if (t.title.showTreeControls) {
                const n = DomElement.createWithHTML(
                    t._currentView.titleBarButtons,
                    'button',
                    'openAll',
                    e.text.openAllButtonSymbolText
            ...
            if (t.showArrayItemsAsSeparateObjects && Is.definedArray(n) && n.length > 1) {
                t._currentView.backButton = DomElement.createWithHTML(
                    t._currentView.titleBarButtons,
                    'button',
                    'back',
                    e.text.backButtonSymbolText
                );
                ...
                t._currentView.nextButton = DomElement.createWithHTML(
                    t._currentView.titleBarButtons,
                    'button',
                    'next',
                    e.text.nextButtonSymbolText
                );
    ...
    function b(t, n, o) {
        ...
        if (s !== 0 || !n.ignore.emptyObjects) {
            ...
            const f = DomElement.createWithHTML(
                u,
                'span',
                n.showValueColors ? `${l} main-title` : 'main-title',
                r ? e.text.mapText : e.text.objectText
            );
            let g = null;
            if (n.showArrayItemsAsSeparateObjects) {
                let e = n.useZeroIndexingForArrays
                    ? n._currentView.dataArrayCurrentIndex.toString()
                    : (n._currentView.dataArrayCurrentIndex + 1).toString();
                ...
                DomElement.createWithHTML(
                    u,
                    'span',
                    n.showValueColors ? `${l} data-array-index` : 'data-array-index',
                    e,
                    f
                );
            }
            if (n.showCounts && s > 0) {
                DomElement.createWithHTML(
                    u,
                    'span',
                    n.showValueColors ? `${l} count` : 'count',
                    `{${s}}`
                );
            }
    ...
    function y(t, n, o) {
        ...
        const c = DomElement.createWithHTML(
            a,
            'span',
            n.showValueColors ? `${l} main-title` : 'main-title',
            r ? e.text.setText : e.text.arrayText
        );
        let d = null;
        if (n.showCounts) {
            DomElement.createWithHTML(
    ...
    function v(t, n, o, r, l, i, a, s) {
        ...
        if (l === null) {
            ...
            if (!o.ignore.dateValues) {
                ...
                f = DomElement.createWithHTML(
                    u,
                    'span',
                    d,
                    DateTime.getCustomFormattedDateText(e, l, o.dateTimeFormat)
                );
                m = 'date';
