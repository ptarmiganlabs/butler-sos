...
- `user` (full payload.context.user if present)
- `userDirectory` (parsed from payload.context.user when available)
- `userId` (parsed from payload.context.user when available)
