    ...
    return {
        ...
        paint: function($element, layout) {
            ...
            var config = {
                ...
                objectIds: layout.tracking && layout.tracking.objectIds ? 
                    layout.tracking.objectIds.split(',').map(function(s) { return s.trim(); }) : 
                    []
            };
            ...
            var statusHtml = 
                ...
                '<p>Tracking: ' +
                (config.trackSelections ? '<span style="color: #0078d4;">✓ Selections</span> ' : '') +
                ...
                '<p style="font-size: 0.9em; color: #666;">Batch interval: ' + config.batchIntervalMs + 'ms</p>' +
                '</div>';
